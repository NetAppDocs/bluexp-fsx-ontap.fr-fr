...
.Avant de commencer
Avant de créer un nouveau volume, vous aurez besoin d'un actif https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-aws.html["Connecteur dans AWS"^].
