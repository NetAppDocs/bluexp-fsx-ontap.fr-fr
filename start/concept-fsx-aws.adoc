...
* Amazon FSX pour NetApp ONTAP est pris en charge lorsque BlueXP est utilisé en _standard_ ou _restricted_ mode.
+
...
+
Reportez-vous à la section link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-modes.html["Modes de déploiement BlueXP"^] pour en savoir plus.
