...
Vous pouvez créer des relations de synchronisation à l'aide de la copie et de la synchronisation BlueXP. Pour configurer des relations de synchronisation, voir https://docs.netapp.com/us-en/cloud-manager-sync/task-creating-relationships.html["création de relations synchronisées"^].
