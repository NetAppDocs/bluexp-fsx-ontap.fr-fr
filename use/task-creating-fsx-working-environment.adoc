...
Vous pouvez découvrir les systèmes de fichiers FSX pour ONTAP quand vous le souhaitez <<Créez un environnement de travail Amazon FSX pour NetApp ONTAP>> Ou en utilisant la page *My Estate*. Cette tâche décrit la découverte à l'aide de *My Estate*
